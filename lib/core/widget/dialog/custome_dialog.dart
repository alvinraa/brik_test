...
///       return CustomDialog(
///         title: const Text('CustomDialog Title'),
...
///
/// {@tool dartpad}
/// This demo shows a [TextButton] which when pressed, calls [showCustomDialog]. When called, this method
...
///
/// {@tool dartpad}
/// This sample shows the creation of [CustomDialog], as described in:
...
///
/// {@tool dartpad}
/// This sample demonstrates how to use [showCustomDialog] to display a dialog box.
///
/// ** See code in examples/api/lib/material/dialog/show_dialog.0.dart **
/// {@end-tool}
///
/// {@tool dartpad}
/// This sample shows the creation of [showCustomDialog], as described in:
/// https://m3.material.io/components/dialogs/overview
///
...
bool _debugIsActive(BuildContext context) {
  if (context is Element && !context.debugIsActive) {
    throw FlutterError.fromParts(<DiagnosticsNode>[
      ...
      ErrorDescription(
          'The showCustomDialog function context parameter is a BuildContext that is no longer valid.'),
      ErrorHint(
        'This can commonly occur when the showCustomDialog function is called after awaiting a Future. '
...
///
/// It is used internally by [showCustomDialog] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showCustomDialog] for a state restoration app example.
///
/// This function takes a `builder` which typically builds a [Dialog] widget.
/// Content below the dialog is dimmed with a [ModalBarrier]. The widget
/// returned by the `builder` does not share a context with the location that
...
/// See also:
///
///  * [showCustomDialog], which is a way to display a DialogRoute.
///  * [showGeneralDialog], which allows for customization of the dialog popup.
///  * [showCupertinoDialog], which displays an iOS-style dialog.
///  * [DisplayFeatureSubScreen], which documents the specifics of how
///    [DisplayFeature]s can split the screen into sub-screens.
...
class _DialogDefaultsM3 extends DialogTheme {
  ...
  Color? get backgroundColor => ElevationOverlay.colorWithOverlay(
      _colors.surfaceContainer, _colors.primary, 6.0);
